...
window.i18n = (() => {
  ...
  const dict = {
    en: {
      ...
      'submit.field.postcodePh':   'e.g. SW1A 1AA (UK) or 75001 (FR)',
      ...
      'page.invitations.subtitle':  'Generate a secure link and send it to a claimant so they can submit their own claim',
      'inv.create.title':           'Generate a new claim link',
      'inv.create.desc':            'Enter the claimant\'s name and policy number. You\'ll get a unique link you can send to them by email, text, or WhatsApp. When they submit, the claim goes straight into your dashboard.',
      'inv.create.type':            'Claim type',
      'inv.create.button':          'Generate link',
      'inv.created.title':          'Link ready — copy and send it',
      'inv.created.body':           'Send this link to {name}. It expires in 30 days.',
      'inv.pending.title':          'Pending links',
      'inv.history.title':          'Past links',
      'inv.table.name':             'Claimant',
      'inv.table.policy':           'Policy',
      'inv.table.type':             'Type',
      'inv.table.sent':             'Sent',
      'inv.table.expires':          'Expires',
      'inv.table.link':             'Link',
      'inv.table.status':           'Status',
      'inv.table.claim':            'Claim ID',
      'inv.status.submitted':       'Submitted',
      'inv.status.expired':         'Expired',
      'inv.empty.title':            'No claim links yet',
      'inv.empty.body':             'Generate one above — it takes 10 seconds.',
      'inv.copy':                   'Copy link',
      'inv.toast.created':          'Link generated',
      'inv.toast.copied':           'Link copied to clipboard',
      'inv.toast.copyFail':         'Could not copy — please copy manually',
      'inv.error.missing':          'Claimant name and policy number are required',

      // ─── Public claimant page ───────────────────────────────────────────
      'public.meta.title':          'Submit Your Claim — ClaimLens AI',
      'public.loading':             'Verifying your claim link…',
      'public.error.title':         'This link can\'t be used',
      'public.error.generic':       'Please contact your insurance broker for a new claim link.',
      'public.error.notFound':      'We couldn\'t find that link. Please check it or contact your broker.',
      'public.error.expired':       'This link has expired. Please contact your broker for a new one.',
      'public.error.alreadyUsed':   'This link has already been used. Contact your broker if you need to submit additional information.',
      'public.form.title':          'Submit Your Claim',
      'public.form.subtitle':       'Please fill in the details of your incident. Your broker will review the information after submission.',
      'public.form.for':            'For:',
      'public.form.type':           'Claim type',
      'public.form.submit':         'Submit claim',
      'public.form.submitting':     'Submitting…',
      'public.form.submitError':    'Something went wrong. Please try again.',
      'public.success.title':       'Thanks — your claim has been submitted',
      'public.success.body':        'Your broker has been notified and will be in touch. Please keep your reference number below in case you need to follow up.',
      'public.success.reference':   'Reference',

      // ─── AI image detection ─────────────────────────────────────────────
      'aiDetect.title':      'AI Image Check',
      'aiDetect.verdict.likely':    'Likely AI-generated',
      'aiDetect.verdict.possible':  'Possibly AI-generated',
      'aiDetect.verdict.unlikely':  'Appears authentic',
      'aiDetect.verdict.skipped':   'Check skipped',
      'aiDetect.verdict.error':     'Check failed',
      'aiDetect.score':      '{n}% AI probability',
      'aiDetect.worst':      'Most suspicious: {name}',
    ...
    fr: {
      ...
      'submit.field.postcodePh':   'ex. 75001 (FR) ou SW1A 1AA (UK)',
      ...
      'page.invitations.title':     'Envoyer un lien de sinistre',
      'page.invitations.subtitle':  'Générez un lien sécurisé à envoyer à un demandeur pour qu\'il soumette son propre sinistre',
      'inv.create.title':           'Générer un nouveau lien de sinistre',
      'inv.create.desc':            'Saisissez le nom et le numéro de police du demandeur. Vous obtiendrez un lien unique à lui envoyer par e-mail, SMS ou WhatsApp. Dès qu\'il soumet, le sinistre arrive directement dans votre tableau de bord.',
      'inv.create.type':            'Type de sinistre',
      'inv.create.button':          'Générer le lien',
      'inv.created.title':          'Lien prêt — copiez-le et envoyez-le',
      'inv.created.body':           'Envoyez ce lien à {name}. Il expire dans 30 jours.',
      'inv.pending.title':          'Liens en attente',
      'inv.history.title':          'Historique des liens',
      'inv.table.name':             'Demandeur',
      'inv.table.policy':           'Police',
      'inv.table.type':             'Type',
      'inv.table.sent':             'Envoyé',
      'inv.table.expires':          'Expire',
      'inv.table.link':             'Lien',
      'inv.table.status':           'Statut',
      'inv.table.claim':            'ID sinistre',
      'inv.status.submitted':       'Soumis',
      'inv.status.expired':         'Expiré',
      'inv.empty.title':            'Aucun lien de sinistre pour l\'instant',
      'inv.empty.body':             'Générez-en un ci-dessus — cela prend 10 secondes.',
      'inv.copy':                   'Copier le lien',
      'inv.toast.created':          'Lien généré',
      'inv.toast.copied':           'Lien copié dans le presse-papiers',
      'inv.toast.copyFail':         'Impossible de copier — veuillez copier manuellement',
      'inv.error.missing':          'Le nom du demandeur et le numéro de police sont requis',

      // ─── Page publique pour le demandeur ────────────────────────────────
      'public.meta.title':          'Soumettre votre sinistre — ClaimLens AI',
      'public.loading':             'Vérification de votre lien de sinistre…',
      'public.error.title':         'Ce lien ne peut pas être utilisé',
      'public.error.generic':       'Veuillez contacter votre courtier d\'assurance pour obtenir un nouveau lien.',
      'public.error.notFound':      'Nous n\'avons pas trouvé ce lien. Vérifiez-le ou contactez votre courtier.',
      'public.error.expired':       'Ce lien a expiré. Veuillez contacter votre courtier pour en obtenir un nouveau.',
      'public.error.alreadyUsed':   'Ce lien a déjà été utilisé. Contactez votre courtier si vous devez envoyer des informations supplémentaires.',
      'public.form.title':          'Soumettre votre sinistre',
      'public.form.subtitle':       'Veuillez remplir les détails de votre incident. Votre courtier examinera les informations après la soumission.',
      'public.form.for':            'Pour :',
      'public.form.type':           'Type de sinistre',
      'public.form.submit':         'Soumettre le sinistre',
      'public.form.submitting':     'Envoi en cours…',
      'public.form.submitError':    'Un problème est survenu. Veuillez réessayer.',
      'public.success.title':       'Merci — votre sinistre a été soumis',
      'public.success.body':        'Votre courtier a été notifié et vous recontactera. Conservez votre numéro de référence ci-dessous en cas de besoin.',
      'public.success.reference':   'Référence',

      // ─── Détection d'images IA ──────────────────────────────────────────
      'aiDetect.title':      'Vérification d\'image IA',
      'aiDetect.verdict.likely':    'Probablement générée par IA',
      'aiDetect.verdict.possible':  'Possiblement générée par IA',
      'aiDetect.verdict.unlikely':  'Semble authentique',
      'aiDetect.verdict.skipped':   'Vérification ignorée',
      'aiDetect.verdict.error':     'Échec de la vérification',
      'aiDetect.score':      '{n}% de probabilité IA',
      'aiDetect.worst':      'Plus suspecte : {name}',
